    ...
    var promise = new Promise(function (resolve, reject) {
        ...
        fs.readFile(xmlPath, function (err, data) {
            ...
            var xml = xmlParser(xmlString, function (err, res) {
                ...
                // Envelope data
                res['soap12:Envelope']['soap12:Body'][0]['GetOrderInfo_V2'][0]['Credentials'][0].Username = config.username
                res['soap12:Envelope']['soap12:Body'][0]['GetOrderInfo_V2'][0]['Credentials'][0].Password = config.password
                res['soap12:Envelope']['soap12:Body'][0]['GetOrderInfo_V2'][0]['Credentials'][0].Token = token
                res['soap12:Envelope']['soap12:Body'][0]['GetOrderInfo_V2'][0].OrderID = orderId
